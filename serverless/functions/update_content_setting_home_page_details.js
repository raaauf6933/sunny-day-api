...
const UpdateContentSetting = async (event, ct, callback) => {
  let uploaded_images = [];
  let files = event.files.files;
  let { home_heading, home_description } = JSON.parse(event.files.data);
...
exports.handler = middy(UpdateContentSetting)
